...
const [senderids, setsenderids] = useState(localStorage.getItem('officeuserid'))
const [sender, setsender] = useState(localStorage.getItem('officeusername'))
...
useEffect(() => {
    ...
    axios.post(`${tz}/user/find2`,{
        _id:localStorage.getItem('officeuserid')

    }).then(res=>{
        console.log(res)
        setaddedusers(res.data.User)
    }).catch(err=>console.log(err))
...
function openthischat(val){
    ...
    axios.post(`${tz}/note/find`,{
        ...
        senderid:localStorage.getItem('officeuserid'),
        recieverid:val._id
       }).then( res=>{
        ...
        <div className="usersdata fullwidth">
          ...
          <div className="messagesection">
            <div  className={lsection}>
             ...
             <h1>{val.name} <div className="roli">
                        User
                        </div></h1>
