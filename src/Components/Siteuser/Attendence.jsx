...
setdull(false)
    ...
    return (
        ...
        <div className="attside attsider right">
...
<div className="headertable clop ">
      ...
      <h3 style={{width:"100px"}}> In</h3>
      <h4 style={{width:"100px"}}>Out</h4>
      <h4 style={{width:"100px"}}> total</h4>
      {/*<h5 style={{width:"100px"}}>Status</h5>*/}
      {/*<h6 style={{width:"100px"}}>Late</h6>*/}
  ...
  {att&&att.map(val=>(
      ...
      <h1 style={{width:"100px"}}>{val.date.replace('2023','23')}</h1>
      <h2 style={{width:"100px"}}> <div className="tinvoice">
        {val.projectname.substring(0,10)}</div> </h2>
      <h3 style={{width:"100px"}} >{val.time}</h3>
      <h4 style={{width:"100px"}} >{val.chkouttime}</h4>
      <h4 style={{width:"100px"}} >{val.workinghours}</h4>
        {/*  <h5 style={{width:"100px"}} >
  {val.status==='Present'?
    <div className="ktypre ktypre2">
        {val.status}
    </div>  :val.status==='Absent'?
      <div className="ktyabs ktypre2">
      {val.status}
  </div>  :  <div className="ktylev ktypre2">
        {val.status}
    </div>  
    }
...
*/}
     {/* <h6 style={{width:"100px"}} >{val.late}</h6>
      */}
