...
const Siteemp2 = () => {
    ...
    useEffect(() => {
        axios.get(`${tz}/siteuser/inactive`).then(res => {
            console.log(res)
    ...
    function deleteuser() {
        if (showusers == 'users') {
            ...
            axios.post(`${tz}/siteuser/delete`, {
                ...
                console.log(res)
                setids('')
                axios.get(`${tz}/siteuser/inactive`).then(res2 => {
                    console.log(res2)
...
<p onClick={e=>setusertype('supervisor')}>Site Supervisor</p>
    ...
    */}
                    ...
                    <div className="subcirc grcirc">
...

                               {
                                   actiontype === 'update' ?
                                       ...
                                       <select className='select2' name="cars" id="cars" value={client} onChange={e => setclient(e.target.value)}>
                                           <>
                ...
                <button onClick={e=>steps<3?setsteps(steps=>steps+1):req()} className='btn1'>{steps<3?"Next":"Finish"}</button>
                </div>
                                </>
            ...
            <div className="sitemap">
                ...
                <div className="newst1">
                    ...
                    <button onClick={e => openskil()} >+ Add Skills</button>
                  
<button   onClick={e => exports()} > Export</button>
                </div>
...
<div className="tablerow table2f " >
                        ...
                        <div className="subtable">
                            ...
                            {searchval.length > 0 && filter === 'name' && currentItems && currentItems.map(val => (
